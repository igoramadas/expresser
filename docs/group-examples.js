;(function() {
    ...
    function groupOne() {
        ...
        $panes
            ...
            .addClass("active")
            .parent()
            .wrapAll("<div class='examples-group panel panel-default'><div class='panel-body'></div></div>")
            .parent()
            .prepend($tabs)
    }
    ...
    function groupExamples() {
        $("pre:has(code)")
            .filter(isFirstOfConsecutiveCodes)
            .each(groupOne)
    }
    ...
    function selectLanguage(lang) {
        ...
        $(".examples-group")
            ...
            .removeClass("active")
        $(".examples-group")
            .find("a[data-examples-group='" + lang + "']")
            .closest("li")
            .addClass("active")
        ...
        if (lang === "@all") {
            ...
            $(".examples-group")
                .find(".tab-pane")
                .addClass("active")
                .css({ float: "left", width: Math.floor(100 / count) + "%", "padding-left": "5px", "padding-right": "5px" })
        } else {
            $(".examples-group")
                .find(".tab-pane")
                .removeClass("active")
                .css({ float: "", width: "", "padding-left": "", "padding-right": "" })
            $(".examples-group")
                .find("code." + lang)
                .closest(".tab-pane")
                .addClass("active")
