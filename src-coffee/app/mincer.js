...
prop(Mincer, '__preProcessors__', new Hash(function() {
    return [];
}));
prop(Mincer, '__postProcessors__', new Hash(function() {
    return [];
}));
prop(Mincer, '__bundleProcessors__', new Hash(function() {
    return [];
}));
prop(Mincer, '__compressors__', new Hash(function() {
    return {};
}));
...
Mincer.registerConfiguration('source_maps', {
    state: 'disabled'
});
...
Mincer.registerConfiguration('source_map', {
    state: 'disabled',
    enable: function(self) {
        self.enable('source_maps');
    },
    disable: function(self) {
        self.disable('source_maps');
    }
});
