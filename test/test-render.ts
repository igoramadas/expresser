...
describe("App Render Tests", function () {
    ...
    it("Renders a simple JSON object", function (done) {
        ...
        supertest.get("/testjson").expect("Content-Type", /json/).expect(200, done)
    })
    ...
    it("Renders a complex JSON object with allow origin header, status 202", function (done) {
        ...
        supertest.get("/complexjson").expect("Content-Type", /json/).expect(202, done)
    })
    ...
    it("Renders an error", function (done) {
        ...
        supertest.get("/testerror").expect("Content-Type", /json/).expect(500, done)
    })
    ...
    it("Renders an error with status 401", function (done) {
        ...
        supertest.get("/testerror-401").expect("Content-Type", /json/).expect(401, done)
    })
    ...
    it("Renders an error from string", function (done) {
        ...
        supertest.get("/testerrorstring").expect("Content-Type", /json/).expect(resIsJson).end(done)
    })
    ...
    it("Renders a timeout error", function (done) {
        ...
        supertest.get("/testerror-timeout").expect("Content-Type", /json/).expect(408, done)
    })
    ...
    it("Renders error message from error.error_description", function (done) {
        ...
        supertest.get("/testerror-error_description").expect("Content-Type", /json/).expect(500, done)
    })
    ...
    it("Renders error message from error.description", function (done) {
        ...
        supertest.get("/testerror-description").expect("Content-Type", /json/).expect(500, done)
    })
    ...
    it("Renders a JPG image", function (done) {
        ...
        supertest.get("/testjpg").expect("Content-Type", /image/).expect(200, done)
    })
